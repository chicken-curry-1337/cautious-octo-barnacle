  ...
  nodes: [
    {
      ...
      options: [{ text: "Конечно!", nextId: "bob_asks" }, { text: "Не очень...", nextId: "end_fail" }],
    },
    {
      id: "bob_asks",
      activeCharacterIds: ["bob"],
      text: "Отлично, Алиса. Ты уже собрала всё необходимое?",
      options: [{ text: "Да, всё с собой.", nextId: "carol_join" }, { text: "Почти.", nextId: "prepare_more" }],
    },
    {
      id: "prepare_more",
      activeCharacterIds: ["alice"],
    ...
    },
    {
      ...
      options: [{ text: "Рады тебя видеть, Кэрол!", nextId: "team_ready" }, { text: "Может, лучше подождать?", nextId: "end_fail" }],
    },
    {
      id: "team_ready",
