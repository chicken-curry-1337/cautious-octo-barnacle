...
export const questChainsConfig: Record<string, QuestChainDefinition> = {
    ...
    stages: [
      {
        ...
        description: 'Совету требуется очистить архивы в {{district}} от пыли и нечисти перед проверкой Лисандры Хельвик.',
        successResult: 'Архивы {{district}} сияют чистотой, найденные манускрипты впечатлили Совет.',
      ...
      },
      {
        ...
        description: 'Лисандра хочет видеть новые тактики. Проведите учения на плацу {{district}} и представьте отчёт о построениях.',
        successResult: 'Учения в {{district}} прошли безукоризненно, Совет впервые заговорил о доверии.',
      ...
      },
      {
        ...
        description: 'Финальная проверка всей инфраструктуры в {{district}}. Лисандра лично прибудет оценить ваши успехи.',
    ...
    stages: [
      {
        ...
        description: 'Арина Стеллар поручает проверить укрепления у ворот {{district}} и устранить уязвимости.',
        successResult: 'Крепостные стены {{district}} укреплены, патрули благодарят вас.',
      ...
      },
      {
        ...
        description: 'Необходимо провести операцию против контрабандистов, скрывающихся в подвалах {{district}}.',
        successResult: 'Склад в {{district}} очищен, контрабандисты обезврежены. Арина довольна.',
      ...
      },
      {
        ...
        description: 'Арина собирает экстренный совет в казармах {{district}} и ждёт аналитики о безопасности города.',
  ...
  merchants_chain: {
    ...
    stages: [
      {
        title: 'Срыв блокад',
        description: 'Верена просит снять блокаду на трактах возле {{district}}, где конкуренты устроили «ремонтные работы».',
        successResult: 'Проезд возле {{district}} свободен, караваны двинулись раньше срока.',
      ...
      },
      {
        ...
        description: 'Нужно сопроводить Верену на торговый форум в {{district}} и защитить документы от шпионажа.',
      ...
      {
        title: 'Совет Верены',
        description: 'Верена готовит закрытый совет Лиги в {{district}} и хочет услышать ваш план экспансии.',
  ...
  cartel_chain: {
    ...
    stages: [
      {
        title: 'Теневой обмен',
        description: 'Кассандра требует организовать подпольный обмен артефактами в переулках {{district}} без лишнего шума.',
        successResult: 'Сделка в {{district}} прошла идеально, Кассандра впечатлена.',
      ...
      },
      {
        ...
        description: 'Нужно внедрить информатора в совет конкурирующей банды, который встречается в подпольном зале {{district}}.',
      ...
      },
      {
        ...
        description: 'Кассандра хочет увидеться в тайном убежище {{district}} с теми, кому можно доверить будущее картеля.',
    ...
    stages: [
      {
        ...
        description: 'Мирелла просит помочь организовать праздник в {{district}}, чтобы поднять дух горожан.',
        successResult: 'Праздник в {{district}} удался, жители поют о вашей гильдии.',
      ...
      },
      {
        ...
        description: 'Сильные приливы разрушают пирсы в {{district}}. Нужна команда, чтобы укрепить набережную.',
        successResult: 'Пирсы {{district}} спасены, рыбаки благодарят вас.',
      ...
      },
      {
        ...
        description: 'Мирелла хочет обсудить будущее сотрудничество и сформировать Совет жителей в зале {{district}}.',
