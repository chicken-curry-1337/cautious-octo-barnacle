...
export const UserCreationDone = observer(({user, setGameScreen}: {user: TUser, setGameScreen(gameScreen: GameScreen): void}) => {
    const {userAbilities, playerName} = user;
    return <div className={styles.userCreationDone}>
        <div>{playerName.name} {playerName.surname}</div>
